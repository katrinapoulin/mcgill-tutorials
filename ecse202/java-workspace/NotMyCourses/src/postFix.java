...
import Queue;
/**
 * <h2>Methods for parsing and conversion</h2>
 * <p>This method exports methods for dealing with expression parsing
 * and conversation.</p>
 * <p>Queue objects are used for input and output.</p>
 * <p>Required methods:</p>
 * <ul><code>public Queue parse (String arg)</code></ul>
 * <ul><code>public Queue In2Post(Queue Qin)</code></ul>
 * <ul>
 *     For assignment 4:
 *     <code> public double postEval(Queue PostFix) </code>
 * </ul>
 *
 * @author antoinephan
 */
